...
public class JCrawler1 {

    private static final Logger LOGGER = LoggerFactory.getLogger(JCrawler1.class);
    ...
    public static JCrawler1 create() {
        return new JCrawler1();
    }

    public JCrawler1 prey(Class<? extends AgamaEntity> prey) {
        this.prey = prey;
        return this;
    }

    public JCrawler1 crawl(Request... requests) {
    ...
    public JCrawler1 crawl(String... urls) {
        for (String url : urls) {
    ...
    public JCrawler1 persistBy(Pipeline pipeline) {
        this.pipeline = pipeline;
        return this;
    }

    public JCrawler1 useConfig(CrawlConfigure config) {
        this.configure = config;
        return this;
    }

    public JCrawler1 downloadBy(Downloader downloader) {
        this.downloader = downloader;
        return this;
    }

    public JCrawler1 processBy(PageProcess pageProcess) {
        this.pageProcess = pageProcess;
        return this;
    }

    public JCrawler1 scheduleBy(Scheduler scheduler) {
        this.scheduler = scheduler;
        return this;
    }

    public JCrawler1 redis(String address) {
