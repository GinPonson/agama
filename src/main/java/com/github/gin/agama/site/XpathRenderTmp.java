...
public class XpathRenderTmp extends AbstractRender{

    private static final Logger LOGGER = LoggerFactory.getLogger(XpathRenderTmp.class);
    ...
    public XpathRenderTmp(Document doc) {
        this.document = doc;
